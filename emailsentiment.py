...
# Create a dataset with well-designed examples for better learning, including email examples
def load_sentiment_dataset():
    return [
        dspy.Example(
            text="The meeting was unexpectedly rescheduled without prior notice.",
            gold_evaluation={
                "emotion": "frustrated", 
                "intensity": 0.4,
                "reasoning": "Unexpected change without notice typically causes frustration"
            }
        ).with_inputs("text"),
        ...
        dspy.Example(
            text="The team successfully completed the project ahead of schedule.",
            gold_evaluation={
                "emotion": "positive", 
                "intensity": 0.8,
                "reasoning": "Success and exceeding expectations indicates strong positive sentiment"
            }
        ).with_inputs("text"),
...
I've been trying to resolve an issue with your product for three weeks now. Despite multiple calls and emails, I'm still experiencing the same problem. This is affecting my work and causing significant delays in my project timelines.
Sincerely,
Michael""",
            gold_evaluation={
                "emotion": "frustrated", 
                "intensity": 0.9,
                "reasoning": "Long-standing unresolved issue despite multiple attempts indicates high frustration"
            }
        ).with_inputs("text")
    ]
